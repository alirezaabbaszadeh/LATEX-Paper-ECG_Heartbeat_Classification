...
\centering
% The script copy_core_figs.py copies any pipeline/diagram PNG to ../figures/pipeline.png
\includegraphics[width=\textwidth]{../figures/pipeline.png}
\end{graphicalabstract}

%% Research highlights (3--5 bullets, ≤ ~85 chars each)
\begin{highlights}
\item Reproducible AAMI-5 ECG pipeline pinned to commit \commitsha.
\item Morlet CWT scalograms with compact CNN+Conformer classifier.
\item Tables/figures built directly from repository run artifacts.
\item Imbalance-aware evaluation using macro-F1 and PR/ROC curves.
\item Open scripts to regenerate all assets for exact replication.
\end{highlights}
