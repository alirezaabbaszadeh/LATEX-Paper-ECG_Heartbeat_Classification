...
\begin{tikzpicture}[x=8.6cm,y=0.62cm,font=\footnotesize]
  ...
  \foreach \x/\lab in {0/0.0,0.2/0.2,0.4/0.4,0.6/0.6,0.8/0.8,1.0/1.0} {\draw[black!15] (\x,0.4) -- (\x,11.5); \node[below,font=\scriptsize] at (\x,0) {\lab};}
  ...
  \fill[blue!70] (0,10.48) rectangle (0.74,10.78); \fill[black!15,draw=black!65] (0,10.03) rectangle (0.90,10.33);
  ...
  \draw[blue!70,line width=1.2pt] (0,8.38) -- (0,8.68); \fill[black!15,draw=black!65] (0,7.93) rectangle (0.67,8.23);
  ...
  \fill[blue!70] (0,6.28) rectangle (0.57,6.58); \fill[black!15,draw=black!65] (0,5.83) rectangle (0.84,6.13);
  ...
  \fill[blue!70] (0,4.18) rectangle (0.01,4.48); \fill[black!15,draw=black!65] (0,3.73) rectangle (0.31,4.03);
  ...
  \draw[blue!70,line width=1.2pt] (0,2.08) -- (0,2.38); \fill[black!15,draw=black!65] (0,1.63) rectangle (0.59,1.93);
