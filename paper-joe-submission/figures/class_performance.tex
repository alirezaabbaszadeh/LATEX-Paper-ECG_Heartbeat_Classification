...
\begin{tikzpicture}[x=8.6cm,y=0.62cm,font=\footnotesize]
  ...
  \node[anchor=west,align=left,font=\scriptsize,text width=8.1cm] at (0,0.65)
    {The gap between AUC and realised F1 for SVEB illustrates why ranking discrimination alone does not establish a useful operating point under severe imbalance. Q contains only two test beats and is descriptive.};
\end{tikzpicture}
